...
#source('C:/Users/George/Documents/Development/src/rebase_col.R')
#source('C:/Users/George/Documents/Development/src/binnarise.R')
...
create_ave_plot_data <- function(x,y_true,y_pred=NULL,w=NULL,rescale=FALSE){
  ...
  dtWorking = data.table(x = x,y_pred = y_pred,y_true = y_true,w = w)
  
  ## Check for NANs
  if(anyNA(dtWorking[,.(y_pred,y_true,w)])) stop('ERROR: NAs present in working frame - check your inputs')
